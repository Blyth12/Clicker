...
img = PhotoImage(file='Assets\images.png')
...
ml = tkinter.Label(f1, text='Menu').grid(row=3, column=5, sticky=W)

#game frame
gl = tkinter.Label(f2, text='Game').grid(row=2, column=1, sticky=W)
...
#shop frame
st = tkinter.Label(s, text='The shop').grid(row=1, column=5, sticky=W)
s1 = tkinter.Button(s,text='Return', command=lambda:raise_frame(f2)).grid(row=1, column=1, sticky=W)
